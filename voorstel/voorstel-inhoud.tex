...
\textcolor{red}{Het probleem ontstaat wanneer twee gesynchroniseerde datacenters tegelijkertijd uitvallen, waardoor de continuïteit van de diensten en de integriteit van transacties in gevaar komt. 
...
\textcolor{red}{Deze bachelorproef analyseert de risico's bij IBM DB2 transactie-logreplicatie van kritieke bancaire mainframe-systemen naar geodistribueerde disaster recovery-omgevingen, met focus op Recovery Point Objectiv (RPO) en Recovery Time Objective (RTO).}
...
\textcolor{red}{
\begin{itemize}
    \item Hoe verschillen de onderzochte DB2-re\-plicatie\-mechanismen (GDPS Global Mirror en Q Replication) in hun herstelmechanismen en ondersteuning voor consistente failover?
    \item Welke zwakheden vertonen deze mechanismen bij asynchrone replicatie van transactielogs en incomplete LUW's (Logical Unit of Work)?
...
\textcolor{red}{Het doel van deze bachelorproef is het analyseren van de risico's die gepaard gaan met het uitbreiden van een synchrone mainframe-opstelling, bestaande uit twee nabijgelegen datacenters, naar een architectuur met een derde, geografisch gescheiden site buiten de maximale afstand voor synchrone data-mirroring. 
Hierbij wordt onderzocht hoe DB2 transactie-logreplicatie kan worden ingezet om data-consistentie en herstelbaarheid te waarborgen en de impact op RPO en RTO inzichtelijk te maken.}
...
Wanneer een systeem faalt, zoals het crashen van een database, wordt traditioneel een hersteltechniek toegepast waarbij transacties doormiddel van logrecords worden geanalyseerd en de reeds gecommitte transacties opnieuw worden uitgevoerd (redo), terwijl onvoltooide of gefaalde transacties ongedaan worden gemaakt (undo) om transactionele consistentie te herstellen \autocite{graefe2022instant}.
...
De geschatte benodigde tijd voor deze fase bedraagt 3 weken \textbf{van 10/02 tot en met 1/03}. 
...
De geschatte tijd voor deze fase bedraagt 2 weken \textbf{van 02/03 tot en met 15/03}.
...
De geschatte tijd voor deze fase bedraagt 3 weken \textbf{van 16/03 tot en met 05/04}.
...
Binnen deze fase wordt ook onderzocht hoe controlled log catch-up wordt toegepast binnen DB2 voor Z/OS, waarbij transactielogs gecontroleerd worden ingehaald tot een consistent herstelpunt. 
Hierbij wordt geanalyseerd onder welke voorwaarden deze techniek incomplete LUW's kan detecteren en corrigeren, en welke beperkingen dit oplegt aan de hersteltijd.
De geschatte tijd voor deze fase bedraagt 3 weken \textbf{van 06/04 tot en met 26/04}.
...
De geschatte tijd voor deze fase bedraagt 2 weken \textbf{van 27/04 tot en met 10/05}.
...
De geschatte tijd voor deze fase bedraagt 2 weken \textbf{van 11/05 tot en met 24/05}.
...
De impact van de verschillende faalscenario's en mitigaties wordt analytisch beoordeeld op basis van vooraf gedefinieerde criteria, waaronder de reeds vermelde RPO die het maximale dataverlies aanduidt, hersteltijd tot operationele beschikbaarheid (RTO) en de mate van transactionele consistentie na herstel.
Deze criteria helpen een duidelijke vergelijking te maken tussen de verscheidene herstelmechanismen en hun effectiviteit.
...
De geschatte tijd voor deze fase bedraagt 3 weken \textbf{van 25/05 tot en met 15/06}. 
