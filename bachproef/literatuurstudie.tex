...
Elk logrecord is identificeerbaar door de RBA, een tijdsaanduiding die specifiek aanduidt wanneer een record startte in de log.
De BSDS is een VSAM key-sequenced data set (KSDS) die alle kritieke informatie van DB2 bevat, zoals de namen van logs. 
